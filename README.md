...
## Além 👌
> Foi criado uma web api simples usando apenas SQL Server. Mesmo assim, o código esta com cobertura de código como pode notar aqui: [![codecov](https://codecov.io/gh/slipalison/ToDoList/branch/main/graph/badge.svg?token=oEv1sNpdD0)](https://codecov.io/gh/slipalison/ToDoList), além disso foi criado uma pipeline para executar os testes automaticamente.
